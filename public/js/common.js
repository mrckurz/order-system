...
export const STR = {
  de: {
    ...
    required: 'Pflicht', tableRequired: 'Bitte Tischnummer eingeben (0 = kein Tisch).',
    finishOrder: 'Bestellung abschließen', reviewTitle: 'Bestellung prüfen', back: 'Zurück',
    savedOffline: 'Offline gespeichert – wird automatisch gesendet',
    ...
    link: 'Link', newLink: 'Neuer Link', copy: 'Kopieren', copied: 'Kopiert!', revoke: 'Abmelden', reactivate: 'Reaktivieren',
    ...
    importMenu: 'Speisekarte importieren', exportMenu: 'Export (CSV)', importBtn: 'Importieren',
    replaceMenu: 'Vorhandene ersetzen', imported: 'Artikel importiert',
    importHint: 'CSV mit Semikolon: Kategorie;Artikel;Preis;Station(drinks/food);Aktiv — eine Zeile je Artikel. Datei wählen oder hier einfügen.',
    ...
    stationsTitle: 'Schank-/Küche-Login anlegen',
    stationsHint: 'Diese Logins öffnen die Schank- (/bar) und Küchen-Bildschirme (/kitchen) und zeigen die Bestellungen deines aktiven Fests.',
    ...
    events: 'Feste', addEvent: 'Fest anlegen', eventName: 'Name des Fests',
    copyMenu: 'Speisekarte kopieren von', noCopy: 'Standard-Speisekarte',
    activate: 'Aktivieren', activeBadge: 'aktiv', closeEvent: 'Abschließen',
    reopenEvent: 'Wieder öffnen', archived: 'abgeschlossen', deleteEvent: 'Löschen',
    statistics: 'Statistik', selectEvent: 'Fest', revenue: 'Umsatz',
  ...
  en: {
    ...
    required: 'required', tableRequired: 'Please enter a table number (0 = no table).',
    finishOrder: 'Review order', reviewTitle: 'Review order', back: 'Back',
    savedOffline: 'Saved offline – will send automatically',
    ...
    link: 'Link', newLink: 'New link', copy: 'Copy', copied: 'Copied!', revoke: 'Log out', reactivate: 'Reactivate',
    ...
    importMenu: 'Import menu', exportMenu: 'Export (CSV)', importBtn: 'Import',
    replaceMenu: 'Replace existing', imported: 'articles imported',
    importHint: 'Semicolon CSV: Category;Item;Price;Station(drinks/food);Active — one line per item. Pick a file or paste here.',
    ...
    stationsTitle: 'Add a bar/kitchen login',
    stationsHint: 'These logins open the Bar (/bar) and Kitchen (/kitchen) screens and show the orders of your active event.',
    ...
    events: 'Events', addEvent: 'New event', eventName: 'Event name',
    copyMenu: 'Copy menu from', noCopy: 'Default menu',
    activate: 'Activate', activeBadge: 'active', closeEvent: 'Close',
    reopenEvent: 'Reopen', archived: 'closed', deleteEvent: 'Delete',
    statistics: 'Statistics', selectEvent: 'Event', revenue: 'Revenue',
